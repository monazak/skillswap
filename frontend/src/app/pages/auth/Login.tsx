    ...
    <div className="min-h-screen bg-gradient-to-br from-[var(--brand-purple-50)] via-[var(--bg-primary)] to-[var(--brand-blue-50)] flex items-center justify-center p-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold mb-2 text-[var(--text-primary)]">Welcome Back</h1>
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-[var(--bg-primary)] text-[var(--text-tertiary)]">Or continue with</span>
              </div>
            </div>
        ...
        <p className="mt-6 text-center text-[var(--text-secondary)]">
          ...
          <Link to="/signup" className="text-[var(--brand-purple-600)] hover:text-[var(--brand-purple-700)] font-medium">
            Sign up
          </Link>
        </p>
      </motion.div>
