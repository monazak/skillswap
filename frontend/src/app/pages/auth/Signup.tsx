    ...
    <div className="min-h-screen bg-gradient-to-br from-[var(--brand-purple-50)] via-[var(--bg-primary)] to-[var(--brand-blue-50)] flex items-center justify-center p-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold mb-2 text-[var(--text-primary)]">Start Your Journey</h1>
          <p className="text-[var(--text-secondary)]">Join thousands exchanging skills every day</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-start gap-2 text-sm">
              ...
              <span className="text-[var(--text-secondary)]">
                I agree to the{' '}
                <a href="#" className="text-[var(--brand-purple-600)] hover:text-[var(--brand-purple-700)]">
                  Terms of Service
                </a>{' '}
                and{' '}
                <a href="#" className="text-[var(--brand-purple-600)] hover:text-[var(--brand-purple-700)]">
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-[var(--bg-primary)] text-[var(--text-tertiary)]">Or sign up with</span>
              </div>
            </div>
        ...
        <p className="mt-6 text-center text-[var(--text-secondary)]">
          ...
          <Link to="/login" className="text-[var(--brand-purple-600)] hover:text-[var(--brand-purple-700)] font-medium">
            Log in
          </Link>
        </p>
      </motion.div>
